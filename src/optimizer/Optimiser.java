...
public class Optimiser {
    ...
    public Optimiser(HashMap<String, Map<String, Object>> tableOfVariables, HashMap<String, List<String>> rpnSet) {
    ...
    public void execute() {
        ...
        for (String funcName : rpnSet.keySet()) {
            ...
            System.out.println("\nОптимизация функции " + funcName);
            System.out.println("Обратная польская запись перед оптимизацией:");
            ...
            if (optimisedRPN.size() < reversePolishNotationCopy.size()) {
                System.out.println("Обратная польская запись после оптимизации:\n" + optimisedRPN);
                rpnSet.replace(funcName, optimisedRPN);
                continue;
            }

            System.out.println("Оптимизация не найдена:\n" + reversePolishNotationCopy);
        }
    }
